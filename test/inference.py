...
def main():    
    ...
    # English
    model = TextProcessor(model_dirs["en"], db_paths["en"], language="en", use_cosmos=False, cosmos_config=cosmos_config, animation_tags_path="animation_data.csv")
    result = model.get_input_ids("Hello", phonemes=False, return_phonemes=True, push_oov_to_cosmos=False, add_blank_token=True)
    ...
    # Swahili 
    model = TextProcessor(model_dirs["sw"], db_paths["sw"], language="sw", use_cosmos=False, cosmos_config=cosmos_config, animation_tags_path="animation_data.csv")
    ...
    # # Indonesian
    model = TextProcessor(model_dirs["id"], db_paths["id"], language="id", use_cosmos=False, cosmos_config=cosmos_config, animation_tags_path="animation_data.csv")
