...
class EmphasisModel:
    def __init__(self, emmphasis_model_path: str, db_path: str, language: str = "en", use_cosmos: bool = False, cosmos_config: Dict[str, Any] = None):
        ...
        if db_path:
            self.load_emphasis_lookup(db_path, use_cosmos=use_cosmos)
        self.tokenizer_manager = Tokenizer(emphasis_model_path, self.emphasis_lookup)
